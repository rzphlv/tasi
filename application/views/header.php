            ...
            <div class="nav-link">
              <div class="user-wrapper">
                <div class="profile-image">
                  <img src="<?php base_url() ?>images/faces/face1.jpg" alt="profile image">
                </div>
                <div class="text-wrapper">
                  <p class="profile-name">Reza Pahlevi</p>
                  <div>
                    <small class="designation text-muted">14116002</small>
                    <span class="status-indicator online"></span>
                  </div>
                </div>
              </div>
                 <a href="<?php echo base_url('daftar')?>" class="btn btn-success btn-block">Daftar T.A +</a>
            </div>
          </li>
          <li class="nav-item">
